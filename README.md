...
- Reports and Analytics: Generates performance, financial, and clinical reports.
The system is designed to reduce paperwork, minimize human error, and provide real-time access to critical data, enhancing decision-making and patient care quality.
...
- Spring Boot — Handles RESTful APIs, business logic, and service orchestration. Great for modularity and scalability.

- Database:
- MySQL — Relational database for storing patient records, staff details, appointments, billing, and inventory data.
  
- Development Tools:
- sta(Spring Tool Suite)
